...
#
#                                Sup People
#                           The Glitch Framework
#                     Pentesting framework by the Mafia Project
#                             
...
configFile = installDir + "/glitch.cfg"
print(installDir)
config = ConfigParser.RawConfigParser()
config.read(configFile)

toolDir = installDir + config.get('glitch', 'toolDir')
logDir = installDir + config.get('glitch', 'logDir')
yes = config.get('glitch', 'yes').split()
...
class glitch:
    ...
    def update(self):
        os.system("git clone --depth=1 https://github.com/YourAnonMafia/glitch.git")
        os.system("cd glitch && bash ./update.sh")
        os.system("glitch")
...
class sniffingSpoofingMenu:
    ...
    def __init__(self):
        ...
        choice6 = raw_input(glitchPrompt)
        clearScr()
        if choice6 == "1":
            setoolkit()
        elif choice6 == "2":
...
class webHackingMenu:
    ...
    def __init__(self):
        ...
        print("   [99]-Back To Main Menu \n")
        choiceweb = raw_input(glitchPrompt)
        clearScr()
        if choiceweb == "1":
            maine()
        elif choiceweb == "2":
...
class postExploitationMenu:
    ...
    def __init__(self):
        ...
        choice11 = raw_input(glitchPrompt)
        clearScr()
        if choice11 == "1":
            sitechecker()
        elif choice11 == "2":
...
class informationGatheringMenu:
    ...
    def __init__(self):
        ...
        print("  {8}--Crips\n  ")
        print("  {99}-Back To Main Menu \n")
        choice2 = raw_input(glitchPrompt)
        clearScr()
        if choice2 == "1":
            nmap()
        elif choice2 == "2":
...
class wirelessTestingMenu:
    ...
    def __init__(self):
        ...
        choice4 = raw_input(glitchPrompt)
        clearScr()
        if choice4 == "1":
            reaver()
        elif choice4 == "2":
...
class exploitationToolsMenu:
    ...
    def __init__(self):
        ...
        choice5 = raw_input(glitchPrompt)
        clearScr()
        if choice5 == "1":
            atscan()
        elif choice5 == "2":
